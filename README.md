...
-   **Server-Side Pagination:** Avoid Memory Bloat. If user has 5,000 tasks, instead of fetching 5,000 rows from SQL it only fetch the first 50 tasks and display the rest if user move to next page.
