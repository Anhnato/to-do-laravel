...
<body class="bg-yellow-50 min-h-screen text-gray-800 font-sans"
    x-data="taskApp({{ json_encode($categories) }}, {{ json_encode($tasks) }})" x-cloak>
        ...
        <div x-show="view === 'grid'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <template x-for="task in filteredTasks" :key="task.id">
                <div
                    ...
                    <div>
                        <h3 class="font-bold text-xl text-gray-800 mb-1 truncate" :title="task.title"
                        ...
                        <p class="text-gray-600 text-sm mb-4 leading-relaxed line-clamp-3" x-text="task.description">
                        </p>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="bg-yellow-50 p-6 rounded-2xl border border-amber-100">
                            <div class="border-b border-amber-200 pb-4">
                                ...
                                <h3 class="text-xl font-bold text-gray-800 truncate" x-text="activeTask.title"></h3>
                            ...
                            <template x-for="cat in categories" :key="cat.id">
                                <div
                                    ...
                                    <button @click="confirmCategoryDelete(cat.id)"
                                        class="text-gray-400 hover:text-red-500 w-8 h-8 rounded-full hover:bg-red-50 transition">
